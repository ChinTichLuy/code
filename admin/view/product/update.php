    ...
    <main>
        <div class="container">
            <form action="" method="POST" enctype="multipart/form-data">
                <!-- khu vuc nhap ten -->
                 <?php $check = $product ?? $product; ?>
                <div style="margin-bottom:16px;">
                    <span>Nhap ten</span>
                    <input type="text" name="ten_hh" value="<?=  $check->ten_hh ?>">

                </div>
                <!-- khu vuc nhap gia -->
                <div style="margin-bottom:16px;">
                    <span>Nhap gia</span>
                    <input type="float" name="don_gia" value="<?= $check->don_gia ?>">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" name="mo_ta" value="<?= $check->mo_ta ?>">
                ...
                <!-- khu vuc nut -->
                <div style="margin-bottom:16px;">
                    <button type="submit" name="submitForm">Hoàn Tất</button>
                </div>
